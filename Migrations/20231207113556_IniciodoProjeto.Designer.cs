...
namespace ProjetoFinalManuela.Migrations
{
    ...
    [Migration("20231207113556_IniciodoProjeto")]
    partial class IniciodoProjeto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Cidade", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Colaborador", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Estado", b =>
                {
                    b.Property<int>("EstadoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.LocalRealizacao", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Procedimento", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.ProcedimentoRealizado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.TipoColaborador", b =>
                {
                    b.Property<int>("TipoColaboradorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("TipoProcedimentoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalManuela.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalManuela.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalManuela.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalManuela.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalManuela.Models.ProcedimentoRealizado", b =>
                {
                    b.HasOne("ProjetoFinalManuela.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalManuela.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalManuela.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalManuela.Models.Procedimento", "Procedimento")
                        .WithMany()
