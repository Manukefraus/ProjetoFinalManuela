...
namespace ProjetoFinalManuela.Controllers
{
    public class CidadeController : Controller
    {
        ...
        {
            ViewData["EstadoId"] = new SelectList(_context.Estado, "EstadoId", "EstadoName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CidadeId,CidadeNome,EstadoId")] Cidade cidade)
        {
            ...
            ViewData["EstadoId"] = new SelectList(_context.Estado, "EstadoId", "EstadoName", cidade.EstadoId);
            return View(cidade);
        }
